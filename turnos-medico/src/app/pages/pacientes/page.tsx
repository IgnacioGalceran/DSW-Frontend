...
export default function ListaPacientes() {
  ...
  const [filteredData, setFilteredData] = useState<Pacientes[]>([]);
  ...
  const pacientesArray = Array.isArray(pacientes.data) ? pacientes.data : [];

  return (
    <React.Fragment>
      <Filter data={pacientesArray} onFilteredData={setFilteredData} />
      ...
      <div className="overflow-auto">
        ...
        <div>
          <ul role="list" className="flex justify-center flex-row flex-wrap">
            {filteredData.map((paciente: Pacientes) => {
